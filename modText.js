...
//phone Business
var RandomBusPhone = Math.floor(Math.random()*10000);
...
$phone.val(phoneNumBus);
$phone.blur();

// mobile phone
var $phone=$('[name=insured_mobile_phone]');
$phone.val(phoneNumMobile);
$phone.blur();
...
$('[name=deductible_1]').val('500');
var $apply_to_1=$('select[name=apply_to_1]');
$('option:eq(2)',$apply_to_1).attr('selected',true);
$apply_to_1.change();
$('[name=coinsurance_1]').val('');
$('[name=reserv_amount_1]').val('');
$('[name=mortgage_holder_1]').val('Bank of America');
